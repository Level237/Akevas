  ...
  useEffect(() => {
    const handleAuthCallback = async () => {
      ...
      try {
        ...
        // Stocker le token avec les mêmes paramètres que dans LoginForm
        ...
        // Ajouter un refreshToken factice ou récupérer le vrai refreshToken depuis l'API
        // Pour l'instant, on utilise le même token comme refreshToken
        ...
        // Attendre un peu pour s'assurer que les cookies sont bien stockés
