                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="text-white space-y-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <button className="bg-[#ed7e0f] px-8 py-4 max-sm:px-4 max-sm:py-2 rounded-xl font-medium hover:bg-[#ed7e0f]/90 transition-all">
                                    Devenir livreur
                                </button>
                                <button className="border border-white/20 px-8 py-4 max-sm:px-4 max-sm:py-2 rounded-xl font-medium hover:bg-white/10 transition-all">
                                    En savoir plus
                                </button>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl max-sm:text-xl font-bold">Flexibilité</h3>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl max-sm:text-xl font-bold">25k FCFA</h3>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl max-sm:text-xl font-bold">Protection</h3>
