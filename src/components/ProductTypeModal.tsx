...
const ProductTypeModal: React.FC<ProductTypeModalProps> = ({
    ...
    const handleConfirm = async () => {
        ...
        if (modalStep === 'type') {
            ...
            setIsLoading(true);
            try {
                // Si vente en gros (isWholesale=true), on force isOnlyWhole à true comme demandé
                // Si vente au détail (isWholesale=false), isOnlyWhole est false
                // On utilise l'état isOnlyWhole qui a été mis à jour par les boutons
