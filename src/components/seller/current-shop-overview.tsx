...
export default function CurrentShopOverView({shop}:{shop:Seller}) {
  ...
  return (
    <div>
            ...
            <div className="flex-1 text-white">
              ...
              <div className="flex items-center gap-6 text-gray-200">
                ...
                <div className="flex items-center">
                  ...
                  <span className='md:w-24 lg:w-full md-text-sm'>{shop.shop.town}-{shop.shop.quarter}</span>
                </div>
                <div className="flex items-center">
      ...
      {/* Content */}
      <div className="container lg:hidden max-sm:block md:block mx-auto px-4 py-6">
        {activeTab === 'products' && (
