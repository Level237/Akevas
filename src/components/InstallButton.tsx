    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed overflow-hidden bottom-10 max-sm:bottom-20 left-4 z-[9999999999] bg-black text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-[#8b0d19] flex items-center justify-center"
            >
                <motion.div
                    animate={{
                        y: [0, -3, 0],
