...
import { Check, Eye, Users, X, Star, MessageCircle, Calendar,Phone, Store } from "lucide-react";
                    ...
                    <TableBody>
                        {!isLoading && reviews?.length > 0 && reviews.map((review: any) => (
                            <TableRow key={review.id}>
                                ...
                                <TableCell>
                                    <span className="text-sm text-gray-600">{review.shop.shop_name}</span>
                                </TableCell>
                                <TableCell>
                        ...
                        <CardContent className="p-0">
                            ...
                            <div className="px-4 pb-4 space-y-3">
                                ...
                                <div className="flex items-center gap-2 text-sm text-gray-600">
                                    ...
                                    <span className="font-medium">{review.shop.shop_name}</span>
                                </div>
                            ...
                            <div className="px-4 pb-4 flex items-center gap-2">
                                <Link to={`/shop/${review.shop.id}`} className="flex-1">
                                    <Button 
                                        variant="outline" 
                                        size="sm" 
