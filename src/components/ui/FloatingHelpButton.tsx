          ...
          >
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg overflow-hidden w-72 border border-gray-100">
              <div className="p-4 bg-gradient-to-br from-[#ed7e0f] to-orange-600">
                <h2 className="text-white font-semibold">Comment pouvons-nous vous aider ?</h2>
                <p className="text-orange-100 text-sm mt-1">Sélectionnez une option ci-dessous</p>
              </div>
                ...
                {menuItems.map((item, index) => (
                  ...
                  >
                    <div className="p-4">
                      ...
                      <p className="text-sm text-gray-500 pl-12">{item.description}</p>
                    </div>
                  </a>
                ))}
              </div>
