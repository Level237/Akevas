...
export default function TopBar() {
  ...
  if (isLoading && !userData) {
    ...
    content = <div className='bg-[#6E0A13] py-3'>
      <div className='flex items-center gap-3 justify-center max-sm:mx-2 mx-16'>
        <div>
          <h2 className='text-lg max-sm:text-xs font-bold text-white'>DEVENEZ LIVREUR SUR AKEVAS</h2>
        </div>
        <div>
          <AsyncLink to="/delivery/guide">
            <Button className='bg-[#ed7e0f] hover:bg-[#ed7e0f]/90 text-md max-sm:text-sm font-bold'>Créer votre compte</Button>
          </AsyncLink>
        </div>
      </div>
    </div>
