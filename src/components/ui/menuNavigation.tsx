        ...
        <nav className="flex justify-center w-full">
                        <ul className="flex justify-center items-center gap-8">
                          ...
                          <li className="py-4">
                           ...
                           <li className="py-4">
                            <AsyncLink to="/seller-registration/personal-info" className="flex text-sm items-center gap-2 text-gray-700 hover:text-orange-500 transition-colors">
              
                              <span className="text-md">Devenir vendeur</span>
                            </AsyncLink>
                          </li>
                          <li className="py-4">
                          ...
                          <li className="py-4">
                            <a href='https://akevas.com/contact' target="_blank" className="flex text-sm items-center gap-2 text-gray-700 hover:text-orange-500 transition-colors">
